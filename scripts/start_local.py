...
def _fingerprint() -> str:
    ...
    for path in (
        ...
        ROOT / "requirements-stage17.txt",
        ROOT / "requirements-stage18.txt",
        ROOT / "requirements-stage19.txt",
        ROOT / "requirements-stage20.txt",
        ROOT / "requirements-stage21.txt",
        ROOT / "requirements-stage22.txt",
...
def bootstrap() -> None:
    ...
    subprocess.run(
        [str(python), "-m", "pip", "install", "-r", str(ROOT / "requirements-stage25.txt")],
        cwd=ROOT,
        check=True,
    )
    subprocess.run(
