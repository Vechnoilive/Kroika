#!/usr/bin/env python3
"""Run only the contract, engine and UI checks introduced at stage 21."""
...
commands = [
    ([sys.executable, "-m", "pytest", "-q", "tests/test_stage21_topology.py"], ROOT),
    ([sys.executable, "-m", "ruff", "check",
      ...
      "tests/test_stage21_topology.py",
      "scripts/start_local.py",
      "scripts/verify_all.py",
      "scripts/verify_stage21.py"], ROOT),
    (["npm", "run", "test:stage21"], ROOT / "frontend"),
...
print(
    "Этап 21 пройден: кокетки, панели, перенос вытачек, hash, интерфейс, "
