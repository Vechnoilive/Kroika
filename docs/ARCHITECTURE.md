...
Версия контрактов: **1.0.0** · Этап расширения: **19/20** · Стиль: модульный монолит.
...
обязательных модулей покрытия и не переиспользует кеш другого плана.
