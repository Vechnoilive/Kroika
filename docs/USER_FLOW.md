...
Это целевой сценарий приложения. На этапе 5 работают создание и повторное открытие проекта, подписанный mock-анализ, пошаговый ввод мерок, черновики и явно выбранные переиспользуемые профили. Ткань, геометрия и экспорт остаются заблокированы до следующих этапов.
