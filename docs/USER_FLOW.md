...
| --- | --- | --- | --- |
| 1. Проект | Создаёт проект, затем выбирает один из семи ограниченных типов | Черновик, краткие подсказки, точный перечень доступных компонентов | Выбран поддержанный тип |
