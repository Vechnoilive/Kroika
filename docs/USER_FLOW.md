...
Это целевой сценарий приложения. На этапе 4 работает его первый безопасный фрагмент: создание/повторное открытие учебного проекта и явно подписанный mock-анализ. Мерки и дальнейшие шаги интерфейс честно блокирует до следующих этапов.
